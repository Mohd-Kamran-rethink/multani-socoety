    ...
    function init() {
        ...
        $(document).on("click", function (event) {
            if (
                ...
                if (
                    $(event.target).parents("a[data-toggle='collapse']")
                        .length > 0 ||
