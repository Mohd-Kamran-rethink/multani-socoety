...
<head>
    <meta charset="UTF-8">
    <title>Multani Society | 404 </title>
...
<body id="app-container" class="ltr rounded background no-footer">
                    ...
                    <div class="auth-card card">
                        ...
                        <div class="form-side"><a aria-current="page" class="white active" href="/"><span
                            ...
                            <p class="display-1 font-weight-bold mb-5">404</p><a
                                class="btn btn-primary btn-shadow btn-lg" href="{{url('/app/login')}}">GO BACK HOME</a>
                        </div>
                    </div>
                </div>
            </div>
